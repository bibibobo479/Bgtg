...
public class WebClient {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // Auth API прокси
        server.createContext("/api/register", new AuthProxyHandler("/api/register"));
        server.createContext("/api/login", new AuthProxyHandler("/api/login"));
        server.createContext("/api/verify", new AuthProxyHandler("/api/verify"));
        server.createContext("/api/resend-code", new AuthProxyHandler("/api/resend-code"));

        // API прокси для основного сервера
        ...
        System.out.println("🔐 Auth сервер: " + AUTH_SERVER_URL);
        System.out.println("📁 Файловый сервер: " + FILE_SERVER_URL);
        System.out.println("============================================================");
    }
    ...
    // Прокси для Auth сервера
    static class AuthProxyHandler implements HttpHandler {
        private final String targetPath;

        public AuthProxyHandler(String targetPath) {
        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            String url = AUTH_SERVER_URL + targetPath;

            System.out.println("🔄 Auth прокси: " + method + " " + url);
            ...
            try {
                ...
                System.err.println("❌ Ошибка Auth прокси: " + e.getMessage());
                e.printStackTrace();
